...
export function classifyPublishFailure(message: string): string {
  ...
  if (
    ...
    text.includes("PublishcreatepagereportedSPUprefillfailure") ||
  ...
  if (
    text.includes("Publishpagedidnotopenafterqueryclick") ||
    text.includes("PlatformSPUpublishnavigationfailed")
  ) {
    return "platform_spu_publish_navigation_failed";
  }
  if (
